...
import org.jbpm.console.ng.cm.client.detailsmulti.CaseDetailsMultiPresenter;
...
public class CaseDetailsPerspective {
    ...
    private final DefaultPlaceRequest overview = new DefaultPlaceRequest(CaseDetailsMultiPresenter.SCREEN_ID);
...
//        perspectiveDefinition.getRoot().insertChild(CompassPosition.SOUTH, stages);
    ...
    public void onStartup(final PlaceRequest place) {
        ...
        addParameters(place, overview, activities, milestones, actions, roles, stages, comments, files);
    }
