...
import org.jbpm.console.ng.cm.client.list.CaseListGridPresenter;
...
public class CaseListPerspective extends AbstractPerspective {
    ...
    public PerspectiveDefinition getPerspective() {
        ...
        p.setName("Cases");
        p.getRoot().addPart(new PartDefinitionImpl(new DefaultPlaceRequest(CaseListGridPresenter.SCREEN_ID)));
        return p;
    }
