...
public class ShowcaseEntryPoint extends DefaultWorkbenchEntryPoint {
    ...
    public void startDefaultWorkbench() {
        GWT.log("Start workbench");
        super.startDefaultWorkbench();

//        final FlowPanel panel = GWT.create(FlowPanel.class);
//        placeManager.goTo(new DefaultPlaceRequest(CaseListPerspective.PERSPECTIVE_ID), panel);
//        RootPanel.get("rootPanel").add(panel);
    }
}